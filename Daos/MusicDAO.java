...
public class MusicDAO {
    ...
    public static boolean  insertMusic(int mu_id, String music_title, String movie_title, String composer) throws SQLException, ClassNotFoundException {
        movie selectedMovie = findMovie(movie_title);
        music newMusic = new music();
        new Music.setMovie_title(selectedMovie.getNameProperty().get());
        boolean returnState = false;
        System.out.println(selectedMovie);
        if(selectedMovie != null){
            String query = "select * from insert_music('"+
